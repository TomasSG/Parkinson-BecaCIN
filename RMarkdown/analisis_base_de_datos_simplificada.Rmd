...
```
En **estimulacion_cerebral** más del 80% de los datos respondieron falos, más del 10% no respondieron y el resto verdadero.

```{r}
g0 + geom_bar(aes(estimulacion_cerebral), na.rm = FALSE)
g0 + geom_bar(aes(educacion), na.rm = TRUE) + coord_flip()
g0 + geom_bar(aes(trabajo), na.rm = TRUE) + coord_flip()
g0 + geom_bar(aes(genero), na.rm = TRUE)
