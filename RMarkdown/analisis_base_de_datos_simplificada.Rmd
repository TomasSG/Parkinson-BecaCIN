...
```
El grupo "Single never married" presenta una edad mediana menor al primer cuartil del resto de los grupos. A su vez el grupo "widowed" presenta el primer cuartil superior al tercer cuartil del resto de grupos, excepto "Other". Además, este último es el grupo que pareciera presentar mayor variabilidad.
...
```
No parece haber diferencia de edades entre ambos grupos, pero si parece haber mayor variabilidad  de edades en el grupo que si fumo.s
