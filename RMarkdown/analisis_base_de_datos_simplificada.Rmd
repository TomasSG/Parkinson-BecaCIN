...
familia_texto <- "Bell MT"
theme_set(theme_gdocs() + theme(title = element_text(family = familia_texto, size = 15),
                                axis.title = element_text(family = familia_texto, face = "bold", size = 10)))
rm(familia_texto)
```
