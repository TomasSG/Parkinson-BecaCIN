...
theme_set(theme_gdocs() + 
            theme(plot.title = element_text(family = familia_texto, 
                                            size = 15, 
                                            face = "bold"),
                  axis.title = element_text(family = familia_texto, 
                                            face = "bold", 
                                            size = 10)))
...
arrange <- ggarrange(plotlist = graficos, nrow = 1, ncol = 2)

annotate_figure(arrange,
                top = text_grob("Boxplot variables de anios", 
                                face = face_titulo, 
                                size = tamanio_titulo))
