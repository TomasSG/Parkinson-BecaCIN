...
* Por cada incremento de una unidad en **d1**, los odds de tener un diagnóstico positivo se incrementan en `r  round(exp(.086348) * 100, 2)`%, manteniendo el resto de variables constantes.
* Por cada incremento de una unidad de **d2**, los odss de tener un diagnóstico positivo se reducen en `r round((1 - exp(-.004163)) * 100, 2)`%, manteniendo el resto de variables constantes.
* Por cada incremento de un año en la **edad**, los odds de tener un diagnóstico positivo se incrementan en `r  round(exp(.104027) * 100, 2)`%, manteniendo el resto de variables constantes.
